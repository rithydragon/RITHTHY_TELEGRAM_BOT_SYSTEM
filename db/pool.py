...
async def create_pool() -> aiomysql.Pool:
    pool = await aiomysql.create_pool(
        ...
        # ssl=ssl_context, # in enable will cause error : 'dict' object has no attribute 'wrap_bio'
        # ssl={"ca": None}, # in enable will cause error : 'dict' object has no attribute 'wrap_bio'
        autocommit=True,
        minsize=2,
        maxsize=10,
        connect_timeout=10,
